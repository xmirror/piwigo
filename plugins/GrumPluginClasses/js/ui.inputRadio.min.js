/* file: ui.inputRadio.js - v1.0.0 | minified on 2011/01/27 with http://jscompress.com/ */
(function($)
...
objects.container.unbind().remove();$this.unbind('.inputRadio').css({width:'',height:''});});},options:function(value)
{return(this.each(function()
